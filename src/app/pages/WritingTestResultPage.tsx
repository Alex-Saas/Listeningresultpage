      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="bg-white rounded-[16px] border border-[#EEEEEE] shadow-sm overflow-hidden">
          ...
          <Tabs.Content value="overview" className="p-4 sm:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height={250}>
                  <RadarChart data={criteriaRadarData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
                    <PolarGrid stroke="#EEEEEE" />
                    <PolarAngleAxis 
                      dataKey="criteria" 
                      tick={{ fontSize: 11, fontFamily: "'IBM Plex Sans Arabic', sans-serif", fill: '#374151' }}
                    />
          ...
          <Tabs.Content value="improvements" className="p-4 sm:p-8">
            ...
            <div className="mt-8 bg-gradient-to-r from-[#F0F9FF] to-[#E0F2FE] rounded-[12px] p-4 sm:p-6 border border-[#BAE6FD]">
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <div className="w-12 h-12 bg-white rounded-[12px] flex items-center justify-center flex-shrink-0">
                  <BookOpen className="w-6 h-6 text-[#C30020]" />
                </div>
                <div className="flex-1">
                  <h4 className="font-['IBM_Plex_Sans_Arabic:Bold',sans-serif] text-[14px] sm:text-[16px] text-[#012269] mb-2">
                    موارد تعليمية إضافية
                  </h4>
                  <p className="font-['IBM_Plex_Sans_Arabic:Regular',sans-serif] text-[13px] sm:text-[14px] text-[#374151] mb-4">
                    للتحسين في هذه المجالات، ننصحك بمراجعة:
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button className="bg-[#012269] text-white px-4 py-2 rounded-[8px] font-['IBM_Plex_Sans_Arabic:SemiBold',sans-serif] text-[13px] sm:text-[14px] hover:bg-[#1B2A4A] transition-colors">
                      درس الروابط المتقدمة
                    </button>
                    <button className="bg-white border border-[#EEEEEE] text-[#374151] px-4 py-2 rounded-[8px] font-['IBM_Plex_Sans_Arabic:SemiBold',sans-serif] text-[13px] sm:text-[14px] hover:bg-gray-50 transition-colors">
                      قائمة المفردات الأكاديمية
                    </button>
                  </div>
                </div>
              </div>
